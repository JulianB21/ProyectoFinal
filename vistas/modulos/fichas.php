...
?>
            ...
            <div class="col-xs-6">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="fin" name="nuevaFechaFin" placeholder="Ingrese Fecha Fin" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask required>
